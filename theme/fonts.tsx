...
const fonts = css`
    ...
    @font-face {
        ...
        src: local(""), url("fonts/roboto-v20-latin-500.woff2") format("woff2"),
            /* Chrome 26+, Opera 23+, Firefox 39+ */ url("fonts/roboto-v20-latin-500.woff")
                format("woff"); /* Chrome 6+, Firefox 3.6+, IE 9+, Safari 5.1+ */
    }
    ...
    @font-face {
        ...
        src: local(""), url("fonts/roboto-v20-latin-900.woff2") format("woff2"),
            /* Chrome 26+, Opera 23+, Firefox 39+ */ url("fonts/roboto-v20-latin-900.woff")
                format("woff"); /* Chrome 6+, Firefox 3.6+, IE 9+, Safari 5.1+ */
    }
    ...
    @font-face {
        ...
        src: local(""), url("fonts/open-sans-v18-latin-800.woff2") format("woff2"),
            /* Chrome 26+, Opera 23+, Firefox 39+ */ url("fonts/open-sans-v18-latin-800.woff")
                format("woff"); /* Chrome 6+, Firefox 3.6+, IE 9+, Safari 5.1+ */
    }
`;
